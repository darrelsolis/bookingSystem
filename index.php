<!--HOMEPAGE: If the user is not logged in-->
<?php
  session_start();
?>
          ...
          <div class="col-md-12">
            ...
            <div class="row" >
               <div class="col-sm-6" id="booking">
                <?php
                    echo "<i><p> You must be registered to book a reservation. </p></i>";
                    echo "<a href=register.php> <input value='REGISTER AN ACCOUNT' class='btn btn-primary btn-block'></a><br>";
                    echo "<a href=login.php> <input value='ALREADY HAVE AN ACCOUNT? LOG IN' class='btn btn-primary btn-block'></a>";                 
                ?>  
               </div>
            </div>
          </div>
