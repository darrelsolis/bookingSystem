<?php
  ...
  /*A session variable gets the booking id of the booking to be deleted*/
  $_SESSION['cancelbooking'] = $_GET['id'];
?>
          ...
          <div class="col-md-12">
            ...
            <div class="row">
              <div  class="col-md-6">
                ...
                <a href="cancelbookingfinal.php"><input type="submit" style="font-family:Montserrat; letter-spacing: 0.5px; font-size: 12px; " value="CANCEL BOOKING"  id="loginbutton" class="btn btn-primary btn-block"></a><br>
                <input type="submit" style="font-family:Montserrat; letter-spacing: 0.5px; font-size: 12px;" value="GO BACK" id="loginbutton" onclick="goBack()" class="btn btn-primary btn-block">
                <script>
                        function goBack() {
                            window.history.back();
                        }
