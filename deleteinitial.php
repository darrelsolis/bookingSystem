          ...
          <div class="col-md-12">
            ...
            <div class="row">
              <div  class="col-md-6">
                ...
                <a href="deletefinal.php"><input type="submit" style="font-family:Montserrat; letter-spacing: 0.5px; font-size: 12px; " value="DELETE MY ACCOUNT"  id="loginbutton" class="btn btn-primary btn-block"></a><br>
