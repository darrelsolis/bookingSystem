      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12">
            ...
            <div class="row">
              <div class="col-md-6">
                <form id="contact-form" method="GET" action="bookProcess.php" class="contact-form">
                  <div class="controls">
                    <div class="menu">
                    ...
                    <hr>
                        <div class="form-group">
                          ...
                          <div class="form-group">
                              ...
                              <input type="text" name="location" placeholder="Enter the location of shoot" required="required" class="form-control">
                          </div>                                        
                        </div>

                    <div class="text-center">
                       <br>
                      <input type="submit" name="book" value="BOOK" class="btn btn-primary btn-block">
                    </div>
                  </div>
                </form>
                </div>
