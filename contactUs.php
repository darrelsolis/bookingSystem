<?php
  ...
  /*Inserts message into "feedback" table*/
          ...
          <div class="container">
            ...
            <div id="navigation" class="collapse navbar-collapse navbar-right">
              <ul class="nav navbar-nav">
                ...
                <li class="active"><a href="index.html">Feedback</a></li>
              </ul>
            </div>
          </div>
        </div>
              ...
              <div class="col-md-6" id="contact">                
                	<?php
	                	if($conn->query($sql) === TRUE){
	      						 echo "<p> Your message has been sent to us. Thank you! </p>";                	 
	      				    }else{
	      						 echo "<p> Error fetching your message: ".$conn->error."</p>";
	      				    }
	      			    ?>
                <a href="index.php" style="font-family:Montserrat; letter-spacing: 0.5px; font-size: 12px"><input type="submit" value="BACK"  id="loginbutton" class="btn btn-primary btn-block" style="width:80px"></a> 
              </div>
            </div>
          </div>
        </div>
