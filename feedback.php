      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12">
            ...
            <div class="row">
              <div class="col-md-6">
                <form id="contact-form" method="GET" action="feedbackProcess.php" class="contact-form">
                  <div class="controls">
                    <div class="menu">
                      <h5 style="font-size: 15px"> <a href="profile.php">About</a> &nbsp/&nbsp
                        <a href="bookings.php">Bookings</a> &nbsp/&nbsp
                        <a style="text-decoration: underline; font-weight: bold; color: black">Feedback</a> &nbsp/&nbsp
                    ...
                    <div class="form-group" id="feedback">
                      ...
                      <textarea rows="4" name="message" placeholder="Enter your message" required="required" class="form-control" style="width:600px"></textarea>
                    </div>

                    <div class="text-center">
                      <input type="submit" value="Send message" class="btn btn-primary btn-block" style="width:600px">
                    </div>                                       
                  </div>
                </form>
              </div>
